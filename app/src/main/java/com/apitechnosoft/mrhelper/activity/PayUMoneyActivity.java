...
public class PayUMoneyActivity extends AppCompatActivity {
     ...
     */
    // Test Variables
    private String mMerchantKey = "BAZmd9GA";
    private String mSalt = "RBt4JVjgUq";
    private String mBaseURL = "https://sandboxsecure.payu.in";//"https://test.payu.in";
...
*/
            mFirstName = "Neeraj singh";
            mEmailId ="neerajk0702@gmail.com";
            mAmount = 11;
            mPhone = "9599230702";
            mId = 0702;
            isFromOrder = true;
            Log.d(Contants.LOG_TAG, "" + mFirstName + " : " + mEmailId + " : " + mAmount + " : " + mPhone);
        ...
        Log.d(Contants.LOG_TAG, "Base Url*********" +mAction);
            /**
             * WebView Client
             */
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                    ...
                    Log.d(Contants.LOG_TAG, "onReceivedError*********" +error);
                }
                ...
                public void onReceivedSslError(WebView view,
                    ...
                    Log.d(Contants.LOG_TAG, "onReceivedSslError*********" +error);
                    handler.proceed();
                }
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        Intent intent = new Intent(PayUMoneyActivity.this, ThankYouActivity.class);
    ...
    public void webViewClientPost(WebView webView, String url,
        ...
        Log.d(Contants.LOG_TAG, "webViewClientPost called: *********" +sb.toString());
    ...
    private void onPressingBack() {
        ...
        if(isFromOrder)
            intent = new Intent(PayUMoneyActivity.this, HomeActivity.class);//need to change
        else
            intent = new Intent(PayUMoneyActivity.this, HomeActivity.class);//
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d(Contants.LOG_TAG, "Payment Successfully. *********");
                }
            });
        }
    }
