...
public class PartyMServicesdataThreeActivity extends AppCompatActivity implements View.OnClickListener{
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_mservicesdata_three);
    ...
    public void chechPortaitAndLandSacpe() {
        if (CompatibilityUtility.isTablet(PartyMServicesdataThreeActivity.this)) {
    ...
    private void parsePartyData() {
        if (data != null) {
            ...
            if (partyMServicesdataThree != null) {
                sunheading = partyMServicesdata.getSubHeading();
                wheredo.setText(heading);
                subHeading.setText(sunheading);
                firstOption.setText(partyMServicesdataThree.getOption());
                secondOption.setText(partyMServicesdataThree.getOption2());
                thirdOption.setText(partyMServicesdataThree.getOption3());
                fourthOption.setText(partyMServicesdataThree.getOption4());
                fifthOption.setText(partyMServicesdataThree.getOption5());
            }
        }
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.nextButtonLayout:
                if (isfirst || isSecond || isThree || isFour || isFive) {
                    ...
                    Utility.alertForErrorMessage("Please select anyone option!", PartyMServicesdataThreeActivity.this);
                }
                break;
        }
    }
    private void setValue(){
        ...
        editor.putString("Step3", selectedValue());
        editor.commit();
        if (!partyMServicesdataFour.getSno().equals("0") && partyMServicesdataFour.getOption() != null && !partyMServicesdataFour.getOption().equals("")) {
            Intent intent = new Intent(PartyMServicesdataThreeActivity.this, PartyMServicesdataFourActivity.class);
            String option2Str = new Gson().toJson(partyMServicesdataFour);
            intent.putExtra("Option2", option2Str);
            intent.putExtra("heading", heading);
            startActivity(intent);
        }else {
            Intent intent = new Intent(PartyMServicesdataThreeActivity.this, AddressActivity.class);
    ...
    private String selectedValue() {
        ...
        if (partyMServicesdataThree != null) {
            if (isfirst) {
                selectvalue = partyMServicesdataThree.getOption();
            } else if (isSecond) {
                selectvalue = partyMServicesdataThree.getOption2();
            } else if (isThree) {
                selectvalue = partyMServicesdataThree.getOption3();
            } else if (isFour) {
                selectvalue = partyMServicesdataThree.getOption4();
            } else if (isFive) {
                selectvalue = partyMServicesdataThree.getOption5();
            }
        }
        return selectvalue;
    }
