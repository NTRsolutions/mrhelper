...
public class PayMentGateWay extends AppCompatActivity {
    ...
    private String tag = "MrhelperLog";
...
//    String salt="ZhraT96O"; // live
    ...
    String merchant_key = "BAZmd9GA"; // test
    String salt = "RBt4JVjgUq"; // test
    String action1 = "";
    private String base_url = "https://sandboxsecure.payu.in";//"https://test.payu.in";
